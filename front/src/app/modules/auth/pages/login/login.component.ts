...
export class LoginComponent implements OnDestroy {
  ...
  private rolePsicopedagogia = EnvServiceFactory().ROLE_PSICOPEDAGOGIA;
    ...
    this._subscriptions.add(
      this._authService.login(data).subscribe({
        next: (res: any) => {
          ...
          if(res.detalle.id_level_user === this.rolePsicopedagogia){
            this._router.navigate(['/home/statistics-data-srq']);
          } else if (res.detalle.id_level_user === 9) {
            this._router.navigate(['/home/residences']);
          }else if(res.detalle.id_level_user === 5) {
            this._router.navigate(['/home/nursing-consultation']);
          }else if(res.detalle.id_level_user === 6) {
            this._router.navigate(['/home/medicine-consultation']);
          }else if(res.detalle.id_level_user === 7) {
            this._router.navigate(['/home/dental-consultation']);
          }
          else{
