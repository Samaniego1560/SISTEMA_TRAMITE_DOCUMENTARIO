...
export interface ConvocatoriaParticipada {
  id_convocatoria: number;
  convocatoria: string;
  fecha_inicio: string;
  fecha_fin: string;
  solicitudes: IStatusRequest[];
}
...
export interface Estudiante {
  ...
  creditos_matriculados: string;
  num_semestres_cursados: string;
  pps: string;
  ppa: string;
  tca: string;
  convocatoria_id: number;
  created_at: string;
  updated_at: string;
  convocatorias_participadas: ConvocatoriaParticipada[];
}
