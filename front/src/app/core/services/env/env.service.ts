...
export class EnvService {
  ...
  public API_GO: string ='';
  public URL_FROND: string ='';
  ...
  public SECTIONS_FAMILY_COMPOSITION: IRequirement[] = [];
  public SECTIONS_DWELLING: IRequirement[] = [];
  public ROLE_PSICOPEDAGOGIA: number = -1;
