        ...
        "/v1/residencias/cuartos/{id}/asignar": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Error en la solicitud: puede incluir errores de validación, habitación sin capacidad (código 93), estudiante ya asignado (código 94), estudiante con otra asignación (código 95), o estudiante no aceptado (código 96)",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/models.Response"
