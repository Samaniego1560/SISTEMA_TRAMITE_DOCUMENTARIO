...
$router->group([], function ($router) {
    ...
    // Student parent survey (public)
    $router->post('/api/survey/student-parent/verify', 'App\\Modules\\StudentParentSurvey\\Http\\Controllers\\StudentParentSurveyController@verify');
    $router->post('/api/survey/student-parent', 'App\\Modules\\StudentParentSurvey\\Http\\Controllers\\StudentParentSurveyController@store');
});
...
$router->group(['middleware' => ['auth', 'restriclevel1']], function ($router) {
    ...
    // Student parent survey export (admin)
    $router->get('/api/survey/student-parent/export', 'App\\Modules\\StudentParentSurvey\\Http\\Controllers\\StudentParentSurveyController@export');
