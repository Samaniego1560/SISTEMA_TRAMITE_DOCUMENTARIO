...
class ConvocatoriaController extends Controller
{
    ...
    public function reporteConvocatoriaYServicio(ReporteConvocatoriaService $reporteService, $id, $tipoServicio)
    {
        error_log($id);
        error_log($tipoServicio);


        try {
            
            return  Response::res('Reporte convocatoria mostrada', $reporteService->reportePorServicio($id, $tipoServicio));
        } catch (ExceptionGenerate $e) {
            return Response::res($e->getMessage(), null, $e->getStatusCode());
        }
    }
